(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://r-neal-kelly.github.io/nkr/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://r-neal-kelly.github.io/nkr/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://r-neal-kelly.github.io/nkr/assets/css/just-the-docs-' + theme + ".css"
      );
    };
