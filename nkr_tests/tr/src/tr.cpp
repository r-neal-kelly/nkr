...
namespace nkr {
    ...
    public:
        ...
        constexpr user_defined_t(value_t value) :
            value(value)
        {
        }
        ...
        constexpr user_defined_t(user_defined_t&& other) noexcept :
            value(cpp::Exchange(other.value, 0))
        {
        }
        ...
        {
            if (this != nkr::cpp::Address(other)) {
                this->value = nkr::cpp::Exchange(other.value, 0);
            }
    ...
    TEST_CASE("trying to figure out why nkr_test_enumeration/types_t has the intellisense error whereas this doesn't. probably something to do with includes!")
    {
        {
            user_defined_t a(1);
            user_defined_t b(2);
