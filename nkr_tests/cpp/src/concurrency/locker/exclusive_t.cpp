...
namespace nkr {
    ...
    {
        static_assert(nkr::generic::implementing::interface::template_ttr<nkr::cpp::concurrency::locker::exclusive_t>);
        using template_template_i = nkr::interface::template_i<nkr::cpp::concurrency::locker::exclusive_t>;

        static_assert(nkr::cpp::is_tr<
                      template_template_i::template_t<nkr::cpp::concurrency::lock::perpetual::unary_t>,
                      nkr::cpp::concurrency::locker::exclusive_t<nkr::cpp::concurrency::lock::perpetual::unary_t>
        >);
        static_assert(nkr::cpp::is_tr<
        ...
        static_assert(nkr::generic::implementing::interface::template_ttr<nkr::cpp::concurrency::locker::exclusive_ttg>);
        using template_tag_i = nkr::interface::template_i<nkr::cpp::concurrency::locker::exclusive_ttg>;
        ...
        static_assert(nkr::cpp::is_tr<
                      ...
                      nkr::cpp::concurrency::locker::exclusive_ttg<nkr::cpp::concurrency::lock::perpetual::unary_t>
        >);
        static_assert(nkr::cpp::is_tr<
