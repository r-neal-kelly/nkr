...
#include "nkr/negatable/integer_max_t.h"
...
namespace nkr {
    ...
    TEST_SUITE("nkr::negatable::integer_8_t, nkr::negatable::integer_16_t, nkr::negatable::integer_32_t, nkr::negatable::integer_64_t")
    {
        template <typename type_p>
        concept is_the_same_as_a_tested_subject_tr =
            nkr::cpp::is_any_tr<type_p, nkr::negatable::integer_8_t> ||
            nkr::cpp::is_any_tr<type_p, nkr::negatable::integer_16_t> ||
            nkr::cpp::is_any_tr<type_p, nkr::negatable::integer_32_t> ||
            nkr::cpp::is_any_tr<type_p, nkr::negatable::integer_64_t>;

        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::byte_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::count_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::index_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_8_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_16_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_32_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_64_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_max_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::integer_min_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::size_t>);
        static_assert(is_the_same_as_a_tested_subject_tr<nkr::negatable::word_t>);
    ...
    #define nkr_ANY_NOT_JUST_CONST_VOLATILE \
        ...
        inline nkr::cpp::just_non_qualified_t<integer_p>
            ...
            noexcept
        {
            nkr::cpp::just_non_qualified_t<integer_p> integer;
            do {
                integer = nkr::randomness::Value<integer_p>();
            } while (integer == 0);
        ...
        inline nkr::cpp::just_non_qualified_t<integer_p>
            ...
            noexcept
        {
            return nkr::randomness::Value<integer_p>(0, nkr::cpp::Default_Max<integer_p>());
        }

        template <typename integer_p>
        inline nkr::cpp::just_non_qualified_t<integer_p>
            Random_Non_Overflow_Add(integer_p a)
            noexcept
        {
            integer_p b = nkr::randomness::Value<integer_p>();
        ...
        template <typename integer_p>
        inline nkr::cpp::just_non_qualified_t<integer_p>
            Random_Non_Overflow_Subtract(integer_p a)
            noexcept
        {
            integer_p b = nkr::randomness::Value<integer_p>();
        ...
        template <typename integer_p>
        inline nkr::cpp::just_non_qualified_t<integer_p>
            Random_Non_Overflow_Multiply(integer_p a)
            noexcept
        {
            integer_p b = nkr::randomness::Value<integer_p>();
        ...
        template <typename integer_p>
        inline nkr::cpp::just_non_qualified_t<integer_p>
            Random_Non_Overflow_Divide(integer_p a)
            noexcept
        {
            integer_p b = Random_Non_Zero<integer_p>();
        ...
        TEST_SUITE("interfaces")
        {
            ...
            TEST_SUITE("nkr::interface::randomness::distributor::uniform_i")
            {
                ...
                TEST_SUITE("static functions")
                {
                    ...
                    {
                        TEST_CASE_TEMPLATE("should always return nkr::cpp::Default_Min<value_t>()", integer_p, nkr_ANY)
                        {
                            using interface_t = nkr::interface::randomness::distributor::uniform_i<integer_p>;
                    ...
                    {
                        TEST_CASE_TEMPLATE("should always return nkr::cpp::Default_Max<value_t>()", integer_p, nkr_ANY)
                        {
                            using interface_t = nkr::interface::randomness::distributor::uniform_i<integer_p>;
                        ...
                        TEST_SUITE("parameters: ()")
                        {
                            TEST_CASE_TEMPLATE("should return a value between default min and default max", integer_p, nkr_ANY)
                            {
                                ...
                                for (nkr::positive::index_t idx = 0, end = Interface_Iteration_Count(); idx < end; idx += 1) {
                                    ...
                                    CHECK(integer >= nkr::cpp::Default_Min<typename interface_t::value_t>());
                                    CHECK(integer <= nkr::cpp::Default_Max<typename interface_t::value_t>());
                                }
                            }
            ...
            TEST_SUITE("nkr::boolean::cpp_t")
            {
                ...
                TEST_SUITE("should convert to true if not 0")
                {
                    TEST_CASE_TEMPLATE("explicit", integer_p, nkr_ANY)
                    {
                        ...
                        integer_p integer = Random_Non_Zero<integer_p>();
        ...
        #define nkr_ANY_WITH_VALUE                                                                          \
            nkr::tuple::types_t<nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,                  \
            nkr::tuple::types_t<const nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,            \
            nkr::tuple::types_t<volatile nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,         \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,   \
            nkr::tuple::types_t<nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,                \
            nkr::tuple::types_t<const nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,          \
            nkr::tuple::types_t<volatile nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,       \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>, \
            nkr::tuple::types_t<nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,                \
            nkr::tuple::types_t<const nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,          \
            nkr::tuple::types_t<volatile nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,       \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>, \
            nkr::tuple::types_t<nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,                \
            nkr::tuple::types_t<const nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,          \
            nkr::tuple::types_t<volatile nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,       \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>  \

        #define nkr_ANY_WITH_LVALUE                                                                                         \
            nkr::tuple::types_t<nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,                                  \
            nkr::tuple::types_t<nkr::negatable::integer_8_t, const nkr::negatable::integer_8_t>,                            \
            nkr::tuple::types_t<nkr::negatable::integer_8_t, volatile nkr::negatable::integer_8_t>,                         \
            nkr::tuple::types_t<nkr::negatable::integer_8_t, const volatile nkr::negatable::integer_8_t>,                   \
            nkr::tuple::types_t<const nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,                            \
            nkr::tuple::types_t<const nkr::negatable::integer_8_t, const nkr::negatable::integer_8_t>,                      \
            nkr::tuple::types_t<const nkr::negatable::integer_8_t, volatile nkr::negatable::integer_8_t>,                   \
            nkr::tuple::types_t<const nkr::negatable::integer_8_t, const volatile nkr::negatable::integer_8_t>,             \
            nkr::tuple::types_t<volatile nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,                         \
            nkr::tuple::types_t<volatile nkr::negatable::integer_8_t, const nkr::negatable::integer_8_t>,                   \
            nkr::tuple::types_t<volatile nkr::negatable::integer_8_t, volatile nkr::negatable::integer_8_t>,                \
            nkr::tuple::types_t<volatile nkr::negatable::integer_8_t, const volatile nkr::negatable::integer_8_t>,          \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_8_t, nkr::negatable::integer_8_t>,                   \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_8_t, const nkr::negatable::integer_8_t>,             \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_8_t, volatile nkr::negatable::integer_8_t>,          \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_8_t, const volatile nkr::negatable::integer_8_t>,    \
            nkr::tuple::types_t<nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,                                \
            nkr::tuple::types_t<nkr::negatable::integer_16_t, const nkr::negatable::integer_16_t>,                          \
            nkr::tuple::types_t<nkr::negatable::integer_16_t, volatile nkr::negatable::integer_16_t>,                       \
            nkr::tuple::types_t<nkr::negatable::integer_16_t, const volatile nkr::negatable::integer_16_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,                          \
            nkr::tuple::types_t<const nkr::negatable::integer_16_t, const nkr::negatable::integer_16_t>,                    \
            nkr::tuple::types_t<const nkr::negatable::integer_16_t, volatile nkr::negatable::integer_16_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_16_t, const volatile nkr::negatable::integer_16_t>,           \
            nkr::tuple::types_t<volatile nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,                       \
            nkr::tuple::types_t<volatile nkr::negatable::integer_16_t, const nkr::negatable::integer_16_t>,                 \
            nkr::tuple::types_t<volatile nkr::negatable::integer_16_t, volatile nkr::negatable::integer_16_t>,              \
            nkr::tuple::types_t<volatile nkr::negatable::integer_16_t, const volatile nkr::negatable::integer_16_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_16_t, nkr::negatable::integer_16_t>,                 \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_16_t, const nkr::negatable::integer_16_t>,           \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_16_t, volatile nkr::negatable::integer_16_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_16_t, const volatile nkr::negatable::integer_16_t>,  \
            nkr::tuple::types_t<nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,                                \
            nkr::tuple::types_t<nkr::negatable::integer_32_t, const nkr::negatable::integer_32_t>,                          \
            nkr::tuple::types_t<nkr::negatable::integer_32_t, volatile nkr::negatable::integer_32_t>,                       \
            nkr::tuple::types_t<nkr::negatable::integer_32_t, const volatile nkr::negatable::integer_32_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,                          \
            nkr::tuple::types_t<const nkr::negatable::integer_32_t, const nkr::negatable::integer_32_t>,                    \
            nkr::tuple::types_t<const nkr::negatable::integer_32_t, volatile nkr::negatable::integer_32_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_32_t, const volatile nkr::negatable::integer_32_t>,           \
            nkr::tuple::types_t<volatile nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,                       \
            nkr::tuple::types_t<volatile nkr::negatable::integer_32_t, const nkr::negatable::integer_32_t>,                 \
            nkr::tuple::types_t<volatile nkr::negatable::integer_32_t, volatile nkr::negatable::integer_32_t>,              \
            nkr::tuple::types_t<volatile nkr::negatable::integer_32_t, const volatile nkr::negatable::integer_32_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_32_t, nkr::negatable::integer_32_t>,                 \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_32_t, const nkr::negatable::integer_32_t>,           \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_32_t, volatile nkr::negatable::integer_32_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_32_t, const volatile nkr::negatable::integer_32_t>,  \
            nkr::tuple::types_t<nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,                                \
            nkr::tuple::types_t<nkr::negatable::integer_64_t, const nkr::negatable::integer_64_t>,                          \
            nkr::tuple::types_t<nkr::negatable::integer_64_t, volatile nkr::negatable::integer_64_t>,                       \
            nkr::tuple::types_t<nkr::negatable::integer_64_t, const volatile nkr::negatable::integer_64_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,                          \
            nkr::tuple::types_t<const nkr::negatable::integer_64_t, const nkr::negatable::integer_64_t>,                    \
            nkr::tuple::types_t<const nkr::negatable::integer_64_t, volatile nkr::negatable::integer_64_t>,                 \
            nkr::tuple::types_t<const nkr::negatable::integer_64_t, const volatile nkr::negatable::integer_64_t>,           \
            nkr::tuple::types_t<volatile nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,                       \
            nkr::tuple::types_t<volatile nkr::negatable::integer_64_t, const nkr::negatable::integer_64_t>,                 \
            nkr::tuple::types_t<volatile nkr::negatable::integer_64_t, volatile nkr::negatable::integer_64_t>,              \
            nkr::tuple::types_t<volatile nkr::negatable::integer_64_t, const volatile nkr::negatable::integer_64_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_64_t, nkr::negatable::integer_64_t>,                 \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_64_t, const nkr::negatable::integer_64_t>,           \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_64_t, volatile nkr::negatable::integer_64_t>,        \
            nkr::tuple::types_t<const volatile nkr::negatable::integer_64_t, const volatile nkr::negatable::integer_64_t>   \
            ...
            TEST_SUITE("binary arithmetic operators: +, -, *, /, %")
            {
                TEST_CASE_TEMPLATE("value", tuple_p, nkr_ANY_WITH_VALUE)
                {
                    ...
                    for (nkr::positive::index_t idx = 0, end = Global_Operator_Iteration_Count(); idx < end; idx += 1) {
                        ...
                        {
                            integer_t a = Random_Non_Zero<integer_t>();
