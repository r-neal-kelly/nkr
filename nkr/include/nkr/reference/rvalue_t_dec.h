...
namespace nkr { namespace reference { namespace rvalue_t$ {
    ...
    public:
        ...
        using type_tg           = nkr::reference::rvalue_tg;

        template <typename ...parameters_p>
        using template_ttg      = nkr::reference::rvalue_ttg<parameters_p...>;
    ...
    public:
        template <typename ...parameters_p>
        using actual_template_t = nkr::reference::rvalue_ttg<parameters_p...>;
