...
*
* @brief
*   Used to filter a type by qualifications, other types, templates, identities, and generics.
*
* @details
...
*   Naturally there are times when using a single type or template as an operand in an nkr::TR expression is not enough. Sometimes one may wish to constain to several operands parenthetically, which can be evaluated with the logical operator of choice. That's where nkr::ts comes in.
* @par
*   Here we constrain to either type in the operand:
* @snippet "./tr/src/tr.cpp" _2e80ad9f_7fa0_4d4f_ba2c_7f56d92659d3
*   To both generics in the operand:
* @snippet "./tr/src/tr.cpp" _898208a2_8cc9_48cb_a4b5_c7bdada49152
*   To just one generic in the operand:
* @snippet "./tr/src/tr.cpp" _ea052059_b418_4201_9690_5166d46ff670
*   And likewise, you can use nkr::ts for multiple subjects. Here we've built an entire set of truth tables where each subject is tested againt the singular operand:
...
* 
* @brief
*   Used to filter a type by qualifications, other types, templates, identities, and generics in the context of a declaration.
*
* @details
