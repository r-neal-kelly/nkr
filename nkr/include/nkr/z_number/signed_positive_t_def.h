...
#include "nkr/z_number/signed_positive_t_dec.h"

namespace nkr {

    template <integer_signed_tr integer_p>
    inline typename signed_positive_t<integer_p>::value_t
        signed_positive_t<integer_p>::To_Value(integer_tr auto from)
    {
        return from % TOTAL;
    }
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>&
        signed_positive_t<integer_p>::operator =(const signed_positive_t& other)
    {
    ...
    template <integer_signed_tr integer_p>
    inline volatile signed_positive_t<integer_p>&
        signed_positive_t<integer_p>::operator =(const signed_positive_t& other)
        volatile
    {
        if (this != std::addressof(other)) {
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>&
        signed_positive_t<integer_p>::operator =(const volatile signed_positive_t& other)
    {
        if (this != std::addressof(other)) {
            this->value = other.value;
        }
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>&
        signed_positive_t<integer_p>::operator =(signed_positive_t&& other)
        noexcept
    {
        if (this != std::addressof(other)) {
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>&
        signed_positive_t<integer_p>::operator =(is_just_volatile_tr<signed_positive_t> auto&& other)
        noexcept
    {
        if (this != std::addressof(other)) {
            this->value = nkr::Move(other.value);
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>::operator value_t()
        const volatile
    {
        return this->value;
    }
    ...
    template <integer_signed_tr integer_p>
    inline auto
        signed_positive_t<integer_p>::operator +(integer_tr auto other)
        const volatile
    {
    ...
    template <integer_signed_tr integer_p>
    inline auto
        signed_positive_t<integer_p>::operator ~()
        const volatile
    {
    ...
    template <integer_signed_tr integer_p>
    inline signed_positive_t<integer_p>
        signed_positive_t<integer_p>::operator ++(int)
        volatile
    {
