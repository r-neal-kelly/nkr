...
namespace nkr { namespace $pointer_t {
    ...
    inline bool_t type_sp<unit_p>::Is_Equal_To(is_any_tr<type_sp> auto a, is_any_tr<type_sp> auto b)
    {
    ...
    inline bool_t non_type_sp<unit_p>::Is_Equal_To(is_any_tr<non_type_sp> auto a, is_any_tr<non_type_sp> auto b)
    {
        return a.units == b.units && a.unit_count == b.unit_count;
    }
