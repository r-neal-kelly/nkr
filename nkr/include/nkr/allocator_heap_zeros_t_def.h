...
namespace nkr { namespace allocator {
    ...
    template <type_tr unit_p>
    inline bool_t heap_zeros_t<unit_p>::Allocate(any_tr<heap_zeros_t> auto& self, any_tr<units_t> auto& units, count_t unit_count)
    {
        return os::heap::Allocate_Zeros(units, unit_count);
    }

    template <type_tr unit_p>
    inline bool_t heap_zeros_t<unit_p>::Allocate(any_tr<heap_zeros_t> auto& self, any_tr<pointer_t> auto& units, count_t unit_count)
    {
    ...
    template <type_tr unit_p>
    inline bool_t heap_zeros_t<unit_p>::Reallocate(any_tr<heap_zeros_t> auto& self, any_tr<units_t> auto& units, count_t new_unit_count)
    {
        return os::heap::Reallocate_Zeros(units, new_unit_count);
    }

    template <type_tr unit_p>
    inline bool_t heap_zeros_t<unit_p>::Reallocate(any_tr<heap_zeros_t> auto& self, any_tr<pointer_t> auto& units, count_t new_unit_count)
    {
    ...
    template <type_tr unit_p>
    inline void_t heap_zeros_t<unit_p>::Deallocate(any_tr<heap_zeros_t> auto& self, any_tr<units_t> auto& units)
    {
        return os::heap::Deallocate_Zeros(units);
    }

    template <type_tr unit_p>
    inline void_t heap_zeros_t<unit_p>::Deallocate(any_tr<heap_zeros_t> auto& self, any_tr<pointer_t> auto& units)
    {
    ...
    template <type_tr unit_p>
    inline bool_t heap_zeros_t<unit_p>::Is_Equal_To(any_tr<heap_zeros_t> auto a, any_tr<heap_zeros_t> auto b)
    {
        return true;
    }
