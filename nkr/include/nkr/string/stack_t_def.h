...
namespace nkr { namespace string {
    ...
    inline const typename stack_t<capacity_p, charcoder_p>::unit_t*
        stack_t<capacity_p, charcoder_p>::Default_C_String()
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline auto&
        stack_t<capacity_p, charcoder_p>::Copy_Assign(is_any_non_const_tr<stack_t> auto& self, const is_any_tr<stack_t> auto& other)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline auto&
        stack_t<capacity_p, charcoder_p>::Move_Assign(is_any_non_const_tr<stack_t> auto& self, is_any_non_const_tr<stack_t> auto& other)
    {
        if (&self != std::addressof(other)) {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline bool_t
        stack_t<capacity_p, charcoder_p>::Has_Terminus(const is_any_tr<stack_t> auto& self)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Unit_Capacity(const is_any_tr<stack_t> auto& self)
    {
    ...
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Unit_Capacity(is_any_non_const_tr<stack_t> auto& self, count_t unit_capacity_including_terminus)
    {
        ...
        return nkr::Move(array_t::Capacity(unit_capacity_including_terminus));
    }

    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Unit_Count(const is_any_tr<stack_t> auto& self)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Unit_Length(const is_any_tr<stack_t> auto& self)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Point_Count(const is_any_tr<stack_t> auto& self)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Point_Length(const is_any_tr<stack_t> auto& self)
    {
        if (Has_Terminus(self)) {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline void_t
        stack_t<capacity_p, charcoder_p>::Push_Terminus(is_any_non_const_tr<stack_t> auto& self)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline void_t
        stack_t<capacity_p, charcoder_p>::Pop_Terminus(is_any_non_const_tr<stack_t> auto& self)
    {
        nkr_ASSERT_THAT(Has_Terminus(self));
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(is_any_non_const_tr<stack_t> auto& self, point_t point)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(is_any_non_const_tr<stack_t> auto& self, const charcoder_t& charcoder)
    {
        count_t unit_count = Unit_Count(self);
        ...
        if (math::Will_Overflow_Add(unit_count, charcoder_length)) {
            ...
            maybe_t<allocator_err> err = Unit_Capacity(unit_count + charcoder_length);
            if (err) {
                return err;
            } else {
                Pop_Terminus(self);
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(is_any_non_const_tr<stack_t> auto& self, const is_any_tr<unit_t> auto* c_string)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(is_any_non_const_tr<stack_t> auto& self, const any_string_tr auto& other)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(is_any_non_const_tr<stack_t> auto& self, any_non_const_string_tr auto&& other)
    {
        nkr_ASSERT_THAT(other.Has_Terminus());
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(const is_any_tr<unit_t> auto* c_string) :
        point_count(0),
        array()
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(const any_string_tr auto& string) :
        point_count(0),
        array()
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(any_non_const_string_tr auto&& string) :
        point_count(0),
        array()
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(const stack_t& other) :
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(const volatile stack_t& other) :
        point_count(other.point_count),
        array(other.array)
    {
    }
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(stack_t&& other) noexcept :
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>::stack_t(volatile stack_t&& other) noexcept :
        point_count(nkr::Move(other.point_count)),
        array(nkr::Move(other.array))
    {
    }
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>&
        stack_t<capacity_p, charcoder_p>::operator =(const stack_t& other)
    {
        return Copy_Assign(*this, other);
    }

    template <count_t capacity_p, charcoder_i charcoder_p>
    inline volatile stack_t<capacity_p, charcoder_p>&
        stack_t<capacity_p, charcoder_p>::operator =(const stack_t& other)
        volatile
    {
        return Copy_Assign(*this, other);
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>&
        stack_t<capacity_p, charcoder_p>::operator =(const volatile stack_t& other)
    {
        return Copy_Assign(*this, other);
    }
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>&
        stack_t<capacity_p, charcoder_p>::operator =(stack_t&& other)
        noexcept
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline stack_t<capacity_p, charcoder_p>&
        stack_t<capacity_p, charcoder_p>::operator =(is_just_volatile_tr<stack_t> auto&& other)
        noexcept
    {
        return Move_Assign(*this, other);
    }
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline bool_t
        stack_t<capacity_p, charcoder_p>::Has_Terminus()
        const
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Unit_Capacity(count_t unit_capacity_including_terminus)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Unit_Count()
        const
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Unit_Length()
        const
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Point_Count()
        const
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline count_t
        stack_t<capacity_p, charcoder_p>::Point_Length()
        const
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(point_t point)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(const charcoder_t& charcoder)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(const is_any_tr<unit_t> auto* c_string)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(const any_string_tr auto& string)
    {
    ...
    template <count_t capacity_p, charcoder_i charcoder_p>
    inline maybe_t<allocator_err>
        stack_t<capacity_p, charcoder_p>::Push(any_non_const_string_tr auto&& string)
    {
