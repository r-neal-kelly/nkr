...
namespace nkr { namespace allocator {
    ...
    private:
        static bool_t   Allocate(same_as_plain_tr<heap_zeros_t> auto& self,
        ...
        static bool_t   Reallocate(same_as_plain_tr<heap_zeros_t> auto& self,
                                   same_as_plain_tr<units_t> auto& units,
        ...
        static void_t   Deallocate(same_as_plain_tr<heap_zeros_t> auto& self,
                                   same_as_plain_tr<units_t> auto& units);
        static void_t   Deallocate(same_as_plain_tr<heap_zeros_t> auto& self,
                                   same_as_plain_tr<pointer_t> auto& units);

        static bool_t   Is_Equal_To(same_as_plain_tr<heap_zeros_t> auto a,
                                    same_as_plain_tr<heap_zeros_t> auto b);

    public:
        friend bool_t   operator ==(same_as_plain_tr<heap_zeros_t> auto a,
                                    same_as_plain_tr<heap_zeros_t> auto b)
        {
