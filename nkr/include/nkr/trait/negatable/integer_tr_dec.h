...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<trait::negatable::integer_tg>
    {
    public:
    ...
    template <>
    class template_i<trait::negatable::integer_ttg>
    {
    public:
        template <typename of_p>
        using type_t    = trait::negatable::integer_tg;
...
#include "nkr/trait/negatable/integer_tr_dec_def.h"
