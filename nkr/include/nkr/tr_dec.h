...
namespace nkr {
    ...
    struct  just_volatile_to_tg     { class tag_lb; class operator_lb; class just_lb; class volatile_lb; class to_lb;               using non_of_tg = just_volatile_to_tg;      using non_to_tg = just_volatile_tg;     using is_tg = just_volatile_to_tg; };
