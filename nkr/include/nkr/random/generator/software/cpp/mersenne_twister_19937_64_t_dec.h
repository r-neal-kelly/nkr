...
namespace nkr { namespace random { namespace generator { namespace software { namespace cpp {
    ...
    using   mersenne_twister_19937_64_t =
        nkr::cpp::random::generator::mersenne_twister_19937_64_t;
...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::random::generator::software::cpp::mersenne_twister_19937_64_tg>
    {
    public:
        using type_t    = nkr::random::generator::software::cpp::mersenne_twister_19937_64_tg;
...
#include "nkr/random/generator/software/cpp/mersenne_twister_19937_64_t_dec_def.h"
