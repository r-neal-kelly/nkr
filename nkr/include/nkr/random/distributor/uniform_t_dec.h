...
namespace nkr { namespace random { namespace distributor {
    ...
    public:
        ...
        using interface_t   = nkr::interface::random::distributor::uniform_i<value_t>;
    ...
    private:
        ...
        static constexpr value_t        Value(tr1<any_tg, uniform_t> auto& self, tr1<any_non_const_tg, generic::random::generator_tg> auto& generator) noexcept;
