...
#ifndef nkr_INCLUDE_GUARD_80342b60_e24f_445f_9946_0598315c8552
#define nkr_INCLUDE_GUARD_80342b60_e24f_445f_9946_0598315c8552
...
namespace nkr { namespace interface { namespace none { namespace value_i$ {
    ...
    class template_i_template_sp :
        public nkr::interface::template_i_identity_template_t<
            ...
            nkr::tuple::types_t<nkr::interface::none::value_i$::example_t>,
            nkr::constant::positive::count_t<1>,
            nkr::constant::positive::count_t<1>,
            nkr::interface::none::value_tg,
            nkr::interface::none::value_ttg
        >
    {
    public:
    };
    ...
    class template_i_tag_sp :
        public nkr::interface::template_i_identity_tag_t<
            template_i_template_sp<nkr::interface::none::value_i>
        >
    {
    public:
    };
