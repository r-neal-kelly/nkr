...
namespace nkr { namespace interface { namespace random { namespace distributor { namespace $uniform_i {
    ...
    concept aliases_i =
        ...
        nkr::generic::built_in::number_tr<typename type_p::number_t>;
...
namespace nkr { namespace interface { namespace random { namespace distributor {
    ...
    {
    public:
        using type_t    = $uniform_i::number_sp<type_p>;
    };
...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::interface::random::distributor::uniform_tg>
    {
    public:
        using type_t    = nkr::interface::random::distributor::uniform_tg;
    ...
    template <nkr::interface::random::distributor::uniform_tr type_p>
    class type_i<type_p> :
        public type_i<nkr::interface::random::distributor::uniform_tg>
    {
    public:
        using type_t    = type_p;
...
namespace nkr { namespace interface {
    ...
    template <>
    class template_i<nkr::interface::random::distributor::uniform_ttg>
    {
    public:
        template <typename inner_p>
        using of_t      = nkr::interface::random::distributor::uniform_i<inner_p>;
    ...
    template <template <typename ...> typename template_p>
        requires nkr::interface::random::distributor::uniform_ttr<template_p>
    class template_i<template_p> :
        public template_i<nkr::interface::random::distributor::uniform_ttg>
    {
    public:
    };
...
namespace nkr { namespace interface { namespace random { namespace distributor { namespace $uniform_i {
    ...
    public:
        template <typename ...>
        constexpr number_sp(...) noexcept   = delete;
    };
...
#include "nkr/interface/random/distributor/uniform_i_dec_def.h"
