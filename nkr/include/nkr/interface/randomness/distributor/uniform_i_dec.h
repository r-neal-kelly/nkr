...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::interface::randomness::distributor::$uniform_t::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::interface::randomness::distributor::$uniform_t::type_i_tag_sp<type_p>;
    };
