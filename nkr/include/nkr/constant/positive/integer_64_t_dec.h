...
namespace nkr { namespace constant { namespace positive {
    ...
    template <nkr::positive::integer_64_t value_p>
    using integer_64_t =
        nkr::constant_t<nkr::positive::integer_64_t, value_p>;

    template <typename type_p>
    concept integer_64_tr =
        nkr::constant_tr<type_p> &&
        nkr::cpp::is_tr<typename type_p::value_t, nkr::positive::integer_64_t>;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::constant::positive::integer_64_t$::type_i_tag_sp<type_p>;
    };
