...
namespace nkr {
    ...
    template <integer_signed_tr integer_p>
    inline volatile signed_negative_t<integer_p>& signed_negative_t<integer_p>::operator =(volatile const signed_negative_t& other) volatile
    {
        if (this != std::addressof(other)) {
            this->value = other.value;
        }
    ...
    template <integer_signed_tr integer_p>
    inline volatile signed_negative_t<integer_p>& signed_negative_t<integer_p>::operator =(volatile signed_negative_t&& other) volatile noexcept
    {
        if (this != std::addressof(other)) {
            this->value = std::exchange(other.value, MAX);
        }
    ...
    template <integer_signed_tr integer_p>
    inline auto signed_negative_t<integer_p>::operator +(integer_tr auto other) volatile const
    {
    ...
    template <integer_signed_tr integer_p>
    inline auto signed_negative_t<integer_p>::operator ~() volatile const
    {
