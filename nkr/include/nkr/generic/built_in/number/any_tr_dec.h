...
#ifndef nkr_INCLUDE_GUARD_e9fa041c_7063_4113_9307_b3d5a7a13845
#define nkr_INCLUDE_GUARD_e9fa041c_7063_4113_9307_b3d5a7a13845
...
namespace nkr { namespace generic { namespace built_in { namespace number { namespace any_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::built_in::number::any_tg,
        nkr::generic::built_in::number::any_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::built_in::number::any_tr$::template_i_tag_sp<template_p>;
    };
