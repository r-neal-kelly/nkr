...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::built_in::number::any_tg>
    {
    public:
        using type_t    = nkr::generic::built_in::number::any_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::built_in::number::any_tg;
        using example_t = nkr::generic::built_in::number::any_tg;
