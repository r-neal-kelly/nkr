...
namespace nkr { namespace generic { namespace built_in {
    ...
    struct  pointer_tg  { class tag_lb; class generic; };
...
namespace nkr { namespace generic { namespace built_in { namespace $pointer_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::built_in::pointer_ttg, nkr::none::type_t>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::built_in::pointer_tg>
    {
    public:
