...
#ifndef nkr_INCLUDE_GUARD_c44f399b_289f_4d46_8e1e_7b722eed4655
#define nkr_INCLUDE_GUARD_c44f399b_289f_4d46_8e1e_7b722eed4655
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::none::any_tr$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace none { namespace any_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::none::any_tg,
        nkr::generic::none::any_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::none::any_tr$::template_i_tag_sp<template_p>;
    };
