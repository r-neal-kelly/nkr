...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::number::real_tg>
    {
    public:
        using type_t    = nkr::generic::number::real_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::number::real_tg;
        using example_t = nkr::generic::number::real_tg;
