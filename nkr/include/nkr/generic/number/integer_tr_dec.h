...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::number::integer_tg>
    {
    public:
        using type_t    = nkr::generic::number::integer_tg;
...
namespace nkr { namespace interface {
    ...
    template <>
    class template_i<nkr::generic::number::integer_ttg>
    {
    public:
        template <typename inner_p>
        using of_t      = nkr::generic::number::integer_tg;
        using example_t = nkr::generic::number::integer_tg;
