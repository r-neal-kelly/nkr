...
#ifndef nkr_INCLUDE_GUARD_30c7c18b_13a0_41e2_baa4_e77df9e70ab2
#define nkr_INCLUDE_GUARD_30c7c18b_13a0_41e2_baa4_e77df9e70ab2
...
namespace nkr { namespace generic {
    ...
    struct  user_defined_tg     { class tag_lb; class generic_lb; };
    ...
    concept user_defined_tr =
        nkr::cpp::user_defined_tr<type_p>;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::user_defined_tr$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace user_defined_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::user_defined_tg,
        nkr::generic::user_defined_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::user_defined_tr$::template_i_tag_sp<template_p>;
    };
