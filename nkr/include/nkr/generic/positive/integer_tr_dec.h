...
#ifndef nkr_INCLUDE_GUARD_204084ff_e2ea_4886_8e1c_3ecc5c2b890e
#define nkr_INCLUDE_GUARD_204084ff_e2ea_4886_8e1c_3ecc5c2b890e
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::positive::integer_tr$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace positive { namespace integer_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::positive::integer_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::positive::integer_tg,
        nkr::generic::positive::integer_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::positive::integer_tr$::template_i_tag_sp<template_p>;
    };
