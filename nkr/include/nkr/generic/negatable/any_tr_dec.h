...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::negatable::any_tg>
    {
    public:
        using type_t    = nkr::generic::negatable::any_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::negatable::any_tg;
        using example_t = nkr::generic::negatable::any_tg;
