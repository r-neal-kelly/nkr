...
#ifndef nkr_INCLUDE_GUARD_25264644_0e8f_41ed_81b2_e34ca3a691e6
#define nkr_INCLUDE_GUARD_25264644_0e8f_41ed_81b2_e34ca3a691e6
...
namespace nkr { namespace generic {
    ...
    struct  positive_tg     { class tag_lb; class generic_lb; };
...
namespace nkr { namespace generic { namespace positive_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::positive_tg,
        nkr::generic::positive_ttg>
    {
    public:
