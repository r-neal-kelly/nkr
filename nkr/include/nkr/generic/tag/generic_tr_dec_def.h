...
#ifndef nkr_INCLUDE_GUARD_1717dd4c_b0bb_4605_9596_a1653423202f
#define nkr_INCLUDE_GUARD_1717dd4c_b0bb_4605_9596_a1653423202f
...
namespace nkr { namespace generic { namespace tag { namespace generic_tr$ {
    ...
    {
        return
            nkr::generic::tag::generic_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::tag::generic_tg>;
    }
