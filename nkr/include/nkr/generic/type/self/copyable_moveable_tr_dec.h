...
namespace nkr { namespace generic { namespace type { namespace self {
    ...
    struct  copyable_moveable_tg    {};

    template <typename>
    struct  copyable_moveable_ttg   {};

    template <typename type_p>
    concept copyable_moveable_tr =
    ...
    concept copyable_moveable_ttr =
        copyable_moveable_tr<typename nkr::interface::template_i<template_p>::example_t>;
...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::type::self::copyable_moveable_tg>
    {
    public:
        using type_t    = nkr::generic::type::self::copyable_moveable_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::type::self::copyable_moveable_tg;
        using example_t = nkr::generic::type::self::copyable_moveable_tg;
...
#include "nkr/generic/type/self/copyable_moveable_tr_dec_def.h"
