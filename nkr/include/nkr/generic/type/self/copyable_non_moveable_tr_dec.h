...
#ifndef nkr_INCLUDE_GUARD_b2261e06_d428_4c4b_bba9_f3906c796315
#define nkr_INCLUDE_GUARD_b2261e06_d428_4c4b_bba9_f3906c796315
...
namespace nkr { namespace generic { namespace type { namespace self {
    ...
    struct  copyable_non_moveable_tg    { class tag_lb; class generic_lb; };
...
namespace nkr { namespace generic { namespace type { namespace self { namespace copyable_non_moveable_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::type::self::copyable_non_moveable_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::type::self::copyable_non_moveable_tg,
        nkr::generic::type::self::copyable_non_moveable_ttg>
    {
    public:
