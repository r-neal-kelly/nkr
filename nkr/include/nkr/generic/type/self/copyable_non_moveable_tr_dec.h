...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::type::self::copyable_non_moveable_tg>
    {
    public:
        using type_t    = nkr::generic::type::self::copyable_non_moveable_tg;
...
namespace nkr { namespace interface {
    ...
    template <>
    class template_i<nkr::generic::type::self::copyable_non_moveable_ttg>
    {
    public:
        template <typename inner_p>
        using of_t      = nkr::generic::type::self::copyable_non_moveable_tg;
        using example_t = nkr::generic::type::self::copyable_non_moveable_tg;
