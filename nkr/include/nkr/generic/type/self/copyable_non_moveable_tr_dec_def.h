...
namespace nkr { namespace generic { namespace type { namespace self { namespace copyable_non_moveable_tr$ {
    ...
    {
        return
            nkr::generic::type::self::copyable_non_moveable_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::type::self::copyable_non_moveable_tg>;
    }
...
namespace nkr { namespace generic { namespace type { namespace self { namespace copyable_non_moveable_tr$ {
    ...
    inline constexpr nkr::boolean::cpp_t
        ...
        noexcept
    {
        return nkr::generic::type::self::copyable_non_moveable_ttr<other_p>;
    }
