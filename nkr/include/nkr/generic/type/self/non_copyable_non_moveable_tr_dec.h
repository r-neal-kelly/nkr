...
#ifndef nkr_INCLUDE_GUARD_0cb3eb57_3372_4b5a_926b_8e07bb7bb17c
#define nkr_INCLUDE_GUARD_0cb3eb57_3372_4b5a_926b_8e07bb7bb17c
...
namespace nkr { namespace generic { namespace type { namespace self {
    ...
    struct  non_copyable_non_moveable_tg    { class tag_lb; class generic_lb; };

    template <typename ...>
    struct  non_copyable_non_moveable_ttg   {};

    template <typename type_p>
    concept non_copyable_non_moveable_tr =
    ...
    concept non_copyable_non_moveable_ttr =
        non_copyable_non_moveable_tr<typename nkr::interface::template_i<template_p>::example_t>;

}}}}

namespace nkr { namespace generic { namespace type { namespace self { namespace non_copyable_non_moveable_tr$ {

    template <nkr::cpp::is_any_tr<nkr::generic::type::self::non_copyable_non_moveable_tg> type_p>
    class type_i_tag_sp
    {
    public:
        using type_t    = type_p;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::type::self::non_copyable_non_moveable_tr$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace type { namespace self { namespace non_copyable_non_moveable_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::type::self::non_copyable_non_moveable_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::type::self::non_copyable_non_moveable_tg,
        nkr::generic::type::self::non_copyable_non_moveable_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::type::self::non_copyable_non_moveable_tr$::template_i_tag_sp<template_p>;
    };

}}

#include "nkr/generic/type/self/non_copyable_non_moveable_tr_dec_def.h"
