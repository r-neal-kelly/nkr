...
namespace nkr { namespace generic { namespace type { namespace self { namespace $non_copyable_non_moveable_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::type::self::non_copyable_non_moveable_ttg, nkr::none::type_t>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::type::self::non_copyable_non_moveable_tg>
    {
    public:
