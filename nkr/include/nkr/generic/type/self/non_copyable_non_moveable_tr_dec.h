...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::type::self::non_copyable_non_moveable_tg>
    {
    public:
        using type_t    = nkr::generic::type::self::non_copyable_non_moveable_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::type::self::non_copyable_non_moveable_tg;
        using example_t = nkr::generic::type::self::non_copyable_non_moveable_tg;
