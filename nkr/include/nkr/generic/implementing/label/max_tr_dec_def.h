...
namespace nkr { namespace generic { namespace implementing { namespace label { namespace max_tr$ {
    ...
    {
        return
            nkr::generic::implementing::label::max_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::implementing::label::max_tg>;
    }
...
namespace nkr { namespace generic { namespace implementing { namespace label { namespace max_tr$ {
    ...
    inline constexpr nkr::boolean::cpp_t
        ...
        noexcept
    {
        return nkr::generic::implementing::label::max_ttr<other_p>;
    }
