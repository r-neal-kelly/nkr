...
namespace nkr { namespace generic { namespace implementing { namespace label { namespace min_tr$ {
    ...
    {
        return
            nkr::generic::implementing::label::min_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::implementing::label::min_tg>;
    }
...
namespace nkr { namespace generic { namespace implementing { namespace label { namespace min_tr$ {
    ...
    inline constexpr nkr::boolean::cpp_t
        ...
        noexcept
    {
        return nkr::generic::implementing::label::min_ttr<other_p>;
    }
