...
#ifndef nkr_INCLUDE_GUARD_1722c59b_8b14_4eed_8bfc_61206f9ae6a2
#define nkr_INCLUDE_GUARD_1722c59b_8b14_4eed_8bfc_61206f9ae6a2
...
namespace nkr { namespace generic { namespace implementing { namespace self {
    ...
    struct  assigner_tg     { class tag_lb; class generic_lb; };
...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace assigner_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::implementing::self::assigner_tg,
        nkr::generic::implementing::self::assigner_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner_tr$::template_i_tag_sp<template_p>;
    };
