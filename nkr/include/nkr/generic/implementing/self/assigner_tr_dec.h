...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::implementing::self::assigner_tg>
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner_tg;
...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::implementing::self::assigner_tg;
        using example_t = nkr::generic::implementing::self::assigner_tg;
