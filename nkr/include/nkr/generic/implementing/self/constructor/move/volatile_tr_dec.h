...
namespace move { namespace $volatile_tr {
    ...
    template <nkr::cpp::is_any_tr<nkr::generic::implementing::self::constructor::move::volatile_tg> type_p>
    class type_i_tag_sp
    {
    public:
        using type_t    = type_p;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::move::$volatile_tr::type_i_tag_sp<type_p>;
    };
...
namespace move { namespace $volatile_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::self::constructor::move::volatile_ttg, nkr::none::type_t>
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::move::$volatile_tr::template_i_tag_sp<template_p>;
    };
