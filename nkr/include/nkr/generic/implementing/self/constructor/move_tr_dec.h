...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::generic::implementing::self::constructor::move_tg>
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::move_tg;
...
namespace nkr { namespace interface {
    ...
    template <>
    class template_i<nkr::generic::implementing::self::constructor::move_ttg>
    {
    public:
        template <typename inner_p>
        using of_t      = nkr::generic::implementing::self::constructor::move_tg;
        using example_t = nkr::generic::implementing::self::constructor::move_tg;
