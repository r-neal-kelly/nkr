...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace constructor {
    ...
    struct  move_tg     { class tag_lb; class generic; };
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::$move_tr::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace constructor { namespace $move_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::self::constructor::move_ttg, nkr::none::type_t>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::implementing::self::constructor::move_tg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::$move_tr::template_i_tag_sp<template_p>;
    };

}}

#include "nkr/generic/implementing/self/constructor/move_tr_dec_def.h"
