...
#ifndef nkr_INCLUDE_GUARD_f4ae7538_d0d8_40a3_9b42_add8ab26f342
#define nkr_INCLUDE_GUARD_f4ae7538_d0d8_40a3_9b42_add8ab26f342
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::copy::non_volatile_tr$::type_i_tag_sp<type_p>;
    };
...
namespace copy { namespace non_volatile_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::self::constructor::copy::non_volatile_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::implementing::self::constructor::copy::non_volatile_tg,
        nkr::generic::implementing::self::constructor::copy::non_volatile_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor::copy::non_volatile_tr$::template_i_tag_sp<template_p>;
    };

}}

#include "nkr/generic/implementing/self/constructor/copy/non_volatile_tr_dec_def.h"
