...
namespace nkr { namespace interface {
    ...
    inline constexpr nkr::boolean::cpp_t
        type_i<nkr::generic::implementing::self::constructor::copy::non_volatile_tg>::Is_Any()
        noexcept
    {
...
namespace nkr { namespace interface {
    ...
    inline constexpr nkr::boolean::cpp_t
        template_i<nkr::generic::implementing::self::constructor::copy::non_volatile_ttg>::Is_Any()
        noexcept
    {
