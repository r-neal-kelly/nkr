...
#ifndef nkr_INCLUDE_GUARD_dca0ccf1_3b05_467f_8d11_813e676da2ad
#define nkr_INCLUDE_GUARD_dca0ccf1_3b05_467f_8d11_813e676da2ad
...
namespace nkr { namespace generic { namespace implementing { namespace self {
    ...
    struct  constructor_tg  { class tag_lb; class generic_lb; };
...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace constructor_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::implementing::self::constructor_tg,
        nkr::generic::implementing::self::constructor_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::constructor_tr$::template_i_tag_sp<template_p>;
    };
