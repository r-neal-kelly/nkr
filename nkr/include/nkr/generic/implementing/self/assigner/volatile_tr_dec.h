...
#ifndef nkr_INCLUDE_GUARD_516ff23f_07ad_4e3f_8db8_09adbad45aa7
#define nkr_INCLUDE_GUARD_516ff23f_07ad_4e3f_8db8_09adbad45aa7
...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace assigner { namespace volatile_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::implementing::self::assigner::volatile_tg,
        nkr::generic::implementing::self::assigner::volatile_ttg>
    {
    public:
