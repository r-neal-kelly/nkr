...
#ifndef nkr_INCLUDE_GUARD_49d92b70_3253_4ed7_b4ae_446daee86e28
#define nkr_INCLUDE_GUARD_49d92b70_3253_4ed7_b4ae_446daee86e28
...
namespace volatile_ { namespace move { namespace non_volatile_tr$ {
    ...
    {
        return
            nkr::generic::implementing::self::assigner::volatile_::move::non_volatile_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::implementing::self::assigner::volatile_::move::non_volatile_tg>;
    }
