...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner::volatile_::copy::$volatile_tr::type_i_tag_sp<type_p>;
    };
...
namespace volatile_ { namespace copy { namespace $volatile_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::self::assigner::volatile_::copy::volatile_ttg, nkr::none::type_t>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::implementing::self::assigner::volatile_::copy::volatile_tg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner::volatile_::copy::$volatile_tr::template_i_tag_sp<template_p>;
    };
