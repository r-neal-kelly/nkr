...
namespace nkr { namespace interface {
    ...
    public:
        ...
        using of_t      = nkr::generic::implementing::self::assigner::volatile_::move::non_volatile_tg;
        using example_t = nkr::generic::implementing::self::assigner::volatile_::move::non_volatile_tg;
