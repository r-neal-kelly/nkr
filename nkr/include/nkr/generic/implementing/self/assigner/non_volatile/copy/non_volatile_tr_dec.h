...
#ifndef nkr_INCLUDE_GUARD_ace4dad8_1054_42a1_8939_1ae63cf33042
#define nkr_INCLUDE_GUARD_ace4dad8_1054_42a1_8939_1ae63cf33042
...
namespace non_volatile { namespace copy { namespace non_volatile_tr$ {
    ...
    {
        { instance = instance }         -> nkr::cpp::is_tr<type_p&>;
        { instance = const_instance }   -> nkr::cpp::is_tr<type_p&>;
    });
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_tr$::type_i_tag_sp<type_p>;
    };
...
namespace non_volatile { namespace copy { namespace non_volatile_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_tg,
        nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_tr$::template_i_tag_sp<template_p>;
    };

}}

#include "nkr/generic/implementing/self/assigner/non_volatile/copy/non_volatile_tr_dec_def.h"
