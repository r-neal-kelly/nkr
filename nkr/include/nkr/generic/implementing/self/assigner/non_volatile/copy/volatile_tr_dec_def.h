...
#ifndef nkr_INCLUDE_GUARD_77a8eabb_1670_4672_bff6_784ed01622ad
#define nkr_INCLUDE_GUARD_77a8eabb_1670_4672_bff6_784ed01622ad
...
namespace non_volatile { namespace copy { namespace volatile_tr$ {
    ...
    {
        return
            nkr::generic::implementing::self::assigner::non_volatile::copy::volatile_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::implementing::self::assigner::non_volatile::copy::volatile_tg>;
    }
