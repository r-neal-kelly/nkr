...
namespace non_volatile { namespace move {
    ...
    struct  volatile_tg     { class tag_lb; class generic; };
...
namespace non_volatile { namespace move { namespace $volatile_tr {
    ...
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::implementing::self::assigner::non_volatile::move::volatile_tg>
    {
    public:
