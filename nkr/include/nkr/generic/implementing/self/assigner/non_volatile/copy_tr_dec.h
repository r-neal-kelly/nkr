...
#ifndef nkr_INCLUDE_GUARD_3865cdb2_2e0d_46bd_b4f1_7d53197d55d1
#define nkr_INCLUDE_GUARD_3865cdb2_2e0d_46bd_b4f1_7d53197d55d1
...
namespace nkr { namespace generic { namespace implementing { namespace self { namespace assigner { namespace non_volatile { namespace copy_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::implementing::self::assigner::non_volatile::copy_tg,
        nkr::generic::implementing::self::assigner::non_volatile::copy_ttg>
    {
    public:
