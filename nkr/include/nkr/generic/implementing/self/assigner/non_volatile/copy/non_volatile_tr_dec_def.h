...
#ifndef nkr_INCLUDE_GUARD_33ff2cf5_fd16_4aeb_ba8e_6248a2db679a
#define nkr_INCLUDE_GUARD_33ff2cf5_fd16_4aeb_ba8e_6248a2db679a
...
namespace non_volatile { namespace copy { namespace non_volatile_tr$ {
    ...
    {
        return
            nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::generic::implementing::self::assigner::non_volatile::copy::non_volatile_tg>;
    }
