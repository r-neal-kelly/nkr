...
namespace nkr { namespace generic { namespace implementing { namespace interface { namespace enumeration {
    ...
    struct  types_tg    { class tag_lb; class generic; };
...
namespace nkr { namespace generic { namespace implementing { namespace interface { namespace enumeration { namespace $types_tr {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::interface::enumeration::types_ttg, nkr::none::type_t>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_aliases_t<nkr::generic::implementing::interface::enumeration::types_tg>
    {
    public:
