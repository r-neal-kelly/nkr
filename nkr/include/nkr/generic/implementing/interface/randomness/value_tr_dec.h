...
#ifndef nkr_INCLUDE_GUARD_d5339527_c1ac_4068_a144_f3cdb25483ff
#define nkr_INCLUDE_GUARD_d5339527_c1ac_4068_a144_f3cdb25483ff
...
namespace nkr { namespace generic { namespace implementing { namespace interface { namespace randomness { namespace value_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::interface::randomness::value_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::implementing::interface::randomness::value_tg,
        nkr::generic::implementing::interface::randomness::value_ttg>
    {
    public:
