...
#ifndef nkr_INCLUDE_GUARD_0b6dff4c_141f_4159_90ad_a086dd8fc8f9
#define nkr_INCLUDE_GUARD_0b6dff4c_141f_4159_90ad_a086dd8fc8f9
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::interface::type_tr$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace generic { namespace implementing { namespace interface { namespace type_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::implementing::interface::type_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::interface::type_tr$::template_i_tag_sp<template_p>;
    };
