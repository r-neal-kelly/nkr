...
namespace nkr { namespace generic { namespace implementing { namespace tag { namespace data { namespace none_tr$ {
    ...
    template <template <typename ...> typename template_p>
        requires nkr::cpp::is_any_ttr<template_p, nkr::generic::implementing::tag::data::none_ttg>
    class template_i_tag_sp :
        public nkr::interface::template_i_generic_tag_t<
        nkr::generic::implementing::tag::data::none_tg,
        nkr::generic::implementing::tag::data::none_ttg>
    {
    public:
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::generic::implementing::tag::data::none_tr$::template_i_tag_sp<template_p>;
    };
