...
#ifndef nkr_INCLUDE_GUARD_c53e8ecd_bd2d_43d8_8162_ec523b2b730c
#define nkr_INCLUDE_GUARD_c53e8ecd_bd2d_43d8_8162_ec523b2b730c
...
namespace nkr { namespace generic {
    ...
    struct  built_in_tg     { class tag_lb; class generic_lb; };
...
namespace nkr { namespace generic { namespace built_in_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::generic::built_in_tg,
        nkr::generic::built_in_ttg>
    {
    public:
