...
namespace nkr { namespace os { namespace heap {
    ...
    /// @{
    bool_t  Allocate(type_pointer_tr auto& units, count_t unit_count);          ///< @copydoc _52a0d839_49c8_4d77_93b1_353137fecd3b
    bool_t  Reallocate(type_pointer_tr auto& units, count_t new_unit_count);    ///< @copydoc _06fa627b_ba42_4b70_b0dd_66146e6d863a
    ...
    /// @{
    bool_t  Allocate_Zeros(type_pointer_tr auto& units, count_t unit_count);        ///< @copydoc _9c5a7296_5644_47bf_bd3f_ff7de3518ce9
    bool_t  Reallocate_Zeros(type_pointer_tr auto& units, count_t new_unit_count);  ///< @copydoc _7d7887a0_3e2d_4502_af8c_d409aae73f0b
