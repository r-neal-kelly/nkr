...
#ifndef nkr_INCLUDE_GUARD_5ba97bd8_dd0c_4116_87be_015480690f8e
#define nkr_INCLUDE_GUARD_5ba97bd8_dd0c_4116_87be_015480690f8e
...
namespace nkr { namespace positive { namespace integer_8_t$ {
    ...
    template <nkr::cpp::is_any_tr<nkr::positive::integer_8_tg> type_p>
    class type_i_tag_sp
    {
    public:
        using type_t    = type_p;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_8_t$::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::positive::integer_8_t$::type_i_tag_sp<type_p>;
    };
