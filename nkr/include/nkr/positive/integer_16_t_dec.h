...
#ifndef nkr_INCLUDE_GUARD_08c1a6d2_085b_4925_afe7_c81e36ac9507
#define nkr_INCLUDE_GUARD_08c1a6d2_085b_4925_afe7_c81e36ac9507
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_16_t$::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::positive::integer_16_t$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace enumeration {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_16_t$::enumeration_types_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness { namespace distributor {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_16_t$::randomness_distributor_uniform_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_16_t$::randomness_value_i_sp<type_p>;
    };
