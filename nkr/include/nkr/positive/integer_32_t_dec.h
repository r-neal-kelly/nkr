...
#ifndef nkr_INCLUDE_GUARD_cd11aa0b_e047_44f1_8ec4_4e0e9a6e1e03
#define nkr_INCLUDE_GUARD_cd11aa0b_e047_44f1_8ec4_4e0e9a6e1e03
...
namespace nkr { namespace positive {
    ...
    struct  integer_32_tg   { class tag_lb; };
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_32_t$::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::positive::integer_32_t$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace enumeration {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_32_t$::enumeration_types_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness { namespace distributor {
    ...
    {
    public:
        using type_t    = nkr::positive::integer_32_t$::randomness_distributor_uniform_i_sp<type_p>;
    };
