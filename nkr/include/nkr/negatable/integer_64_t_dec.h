...
#ifndef nkr_INCLUDE_GUARD_66599535_6529_4f52_88cb_51992dda22d6
#define nkr_INCLUDE_GUARD_66599535_6529_4f52_88cb_51992dda22d6
...
namespace nkr { namespace negatable { namespace integer_64_t$ {
    ...
    template <nkr::cpp::is_any_tr<nkr::negatable::integer_64_tg> type_p>
    class type_i_tag_sp
    {
    public:
        using type_t    = type_p;
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace none {
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::none_value_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace enumeration {
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::enumeration_types_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness { namespace distributor {
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::randomness_distributor_uniform_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness {
    ...
    {
    public:
        using type_t    = nkr::negatable::integer_64_t$::randomness_value_i_sp<type_p>;
    };
