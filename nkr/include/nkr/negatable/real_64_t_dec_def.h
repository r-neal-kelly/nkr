...
#ifndef nkr_INCLUDE_GUARD_1090a6d6_4e3d_477c_921f_f6fde04559e6
#define nkr_INCLUDE_GUARD_1090a6d6_4e3d_477c_921f_f6fde04559e6
...
namespace nkr { namespace negatable { namespace real_64_t$ {
    ...
    {
        return
            nkr::negatable::real_64_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::negatable::real_64_tg>;
    }
    ...
    inline constexpr nkr::boolean::cpp_t
        ...
        noexcept
    {
        return nkr::negatable::real_64_t$::Is_Any_General<other_p>();
    }
