...
#ifndef nkr_INCLUDE_GUARD_e0b1f35a_dd67_4458_b183_764ffa951496
#define nkr_INCLUDE_GUARD_e0b1f35a_dd67_4458_b183_764ffa951496
...
namespace nkr { namespace negatable {
    ...
    struct  real_64_tg  { class tag_lb; };
...
namespace nkr { namespace interface {
    ...
    {
    public:
        using type_t    = nkr::negatable::real_64_t$::type_i_type_sp<type_p>;
    };
    ...
    {
    public:
        using type_t    = nkr::negatable::real_64_t$::type_i_tag_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace none {
    ...
    {
    public:
        using type_t    = nkr::negatable::real_64_t$::none_value_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness { namespace distributor {
    ...
    {
    public:
        using type_t    = nkr::negatable::real_64_t$::randomness_distributor_uniform_i_sp<type_p>;
    };
...
namespace nkr { namespace interface { namespace randomness {
    ...
    {
    public:
        using type_t    = nkr::negatable::real_64_t$::randomness_value_i_sp<type_p>;
    };
