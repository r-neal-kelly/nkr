...
#ifndef nkr_INCLUDE_GUARD_6660d30d_366a_4ea1_b913_f429ab4fc7db
#define nkr_INCLUDE_GUARD_6660d30d_366a_4ea1_b913_f429ab4fc7db
...
namespace nkr { namespace negatable { namespace integer_32_t$ {
    ...
    {
        return
            nkr::negatable::integer_32_tr<other_p> ||
            nkr::cpp::is_any_tr<other_p, nkr::negatable::integer_32_tg>;
    }
    ...
    inline constexpr nkr::boolean::cpp_t
        ...
        noexcept
    {
        return nkr::negatable::integer_32_t$::Is_Any_General<other_p>();
    }
