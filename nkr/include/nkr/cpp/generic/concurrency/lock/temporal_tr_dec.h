...
#ifndef nkr_INCLUDE_GUARD_4895858b_58bb_4dac_b710_1b4eeb64beb5
#define nkr_INCLUDE_GUARD_4895858b_58bb_4dac_b710_1b4eeb64beb5
...
namespace nkr { namespace cpp { namespace generic { namespace concurrency { namespace lock { namespace temporal_tr$ {
    ...
    class template_i_tag_sp :
        ...
        nkr::cpp::generic::concurrency::lock::temporal_tg,
        nkr::cpp::generic::concurrency::lock::temporal_ttg>
    {
    public:
