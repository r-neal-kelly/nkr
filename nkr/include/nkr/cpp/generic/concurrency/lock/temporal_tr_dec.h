...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<nkr::cpp::generic::concurrency::lock::temporal_tg>
    {
    public:
        using type_t    = nkr::cpp::generic::concurrency::lock::temporal_tg;
...
namespace nkr { namespace interface {
    ...
    template <>
    class template_i<nkr::cpp::generic::concurrency::lock::temporal_ttg>
    {
    public:
        template <typename ...>
        using template_t    = nkr::cpp::generic::concurrency::lock::temporal_tg;

        template <typename inner_p>
        using of_t          = nkr::cpp::generic::concurrency::lock::temporal_tg;

        template <nkr::tuple::types_tr parameters_p>
        using of_tuple_t    = nkr::cpp::generic::concurrency::lock::temporal_tg;

        template <typename ...parameters_p>
        using of_pack_t     = nkr::cpp::generic::concurrency::lock::temporal_tg;

        using example_t     = nkr::cpp::generic::concurrency::lock::temporal_tg;
