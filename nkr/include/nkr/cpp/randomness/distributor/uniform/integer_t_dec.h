...
namespace nkr { namespace cpp { namespace randomness { namespace distributor { namespace uniform { namespace integer_t$ {
    ...
    public:
        ...
        using type_tg           = nkr::cpp::randomness::distributor::uniform::integer_tg;

        template <typename ...parameters_p>
        using template_ttg      = nkr::cpp::randomness::distributor::uniform::integer_ttg<parameters_p...>;
    ...
    public:
        template <typename ...parameters_p>
        using actual_template_t = nkr::cpp::randomness::distributor::uniform::integer_ttg<parameters_p...>;
