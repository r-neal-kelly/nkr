...
namespace nkr { namespace cpp { namespace concurrency { namespace locker { namespace exclusive_t$ {
    ...
    public:
        ...
        using type_tg           = nkr::cpp::concurrency::locker::exclusive_tg;

        template <typename ...parameters_p>
        using template_ttg      = nkr::cpp::concurrency::locker::exclusive_ttg<parameters_p...>;
    ...
    public:
        template <typename ...parameters_p>
        using actual_template_t = nkr::cpp::concurrency::locker::exclusive_ttg<parameters_p...>;
