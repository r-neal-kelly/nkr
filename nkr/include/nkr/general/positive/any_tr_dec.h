...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<general::positive::any_tg>
    {
    public:
    ...
    template <>
    class template_i<general::positive::any_ttg>
    {
    public:
        template <typename of_p>
        using type_t    = general::positive::any_tg;
...
#include "nkr/general/positive/any_tr_dec_def.h"
