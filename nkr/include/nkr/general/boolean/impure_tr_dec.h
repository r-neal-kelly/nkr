...
namespace nkr { namespace general { namespace boolean { namespace $impure_tr {
...
namespace nkr { namespace interface {
    ...
    template <>
    class type_i<general::boolean::impure_tg>
    {
    public:
    ...
    template <>
    class template_i<general::boolean::impure_ttg>
    {
    public:
        template <typename of_p>
        using type_t    = general::boolean::impure_tg;
...
#include "nkr/general/boolean/impure_tr_dec_def.h"
