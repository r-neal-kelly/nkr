...
#include "nkr/z_string/stack_t_dec.h"
...
namespace nkr { namespace string {
                                                    ...
                                                    count_t unit_count_or_length)
    {
        ...
        count_t other_unit_length = unit_count_or_length > 0 && c_string[unit_count_or_length - 1] == 0 ?
        ...
        if (math::Will_Overflow_Add(original_unit_count, other_unit_length)) {
            ...
            if (err) {
                ...
                if constexpr (charcoder_t::Max_Unit_Count() > 1) {
                    const count_t offset_to_new_mid_point = Offset_To_New_Mid_Point<stack_t>(self, c_string, other_unit_length);
                    ...
                    other_unit_length -= offset_to_new_mid_point;
                } else {
                    Pop_Terminus(self);
                }
